        ...
        <div className="flex flex-col min-h-screen bg-[#121212] text-white">
            ...
            <div className="flex flex-col bg-[#1E1E1E] p-8 border-t border-gray-800 overflow-y-auto">
                ...
                <motion.section ref={skillsRef} initial="hidden" whileInView="visible" variants={animationVariants}>
                    ...
                    <Skills /> <br /> <br /> <br />
                    <h2 className="text-3xl font-bold text-yellow-400 mt-4">Currently I am</h2>
                    <CurrentlyIam /> <br /> <br /> <br />
                </motion.section>

                <motion.section ref={othersRef} initial="hidden" whileInView="visible" variants={animationVariants}>
                    <h2 className="text-3xl font-bold text-yellow-400 mb-4">My Hobbies</h2>
                    <MyHobbies /> <br /> <br /> <br />
                    <h2 className="text-3xl font-bold text-yellow-400 mt-4">Fun Facts About Me</h2>
                    <FunFacts /> <br /> <br /> <br />
                </motion.section>
