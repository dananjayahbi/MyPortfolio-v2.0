...
export async function GET() {
    if (!fs.existsSync(contentFilePath)) {
        const defaultContent = {
            author: { name: "John Doe", post: "Web Developer" },
            aboutMe: { title: "About Me", description: "A passionate web developer." },
            skills: {
                title: "Skills",
                subTitles: [
            ...
            currentlyIAm: { title: "Currently I Am", texts: ["Learning TypeScript", "Building Projects"] },
            myHobbies: { title: "My Hobbies", texts: ["Coding", "Reading"] },
            funFacts: { title: "Fun Facts", texts: ["I love coding challenges!"] },
            experience: { title: "Experience", texts: ["3 Years in Web Development"] },
    ...
    return NextResponse.json({ message: "Portfolio content initialized successfully." });
}
